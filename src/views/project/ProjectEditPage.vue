...
export default {
    ...
    methods: {
        ...
        injectData(data) {
            ...
            this.deadline = data.deadline.substr(0, 10);
            this.files = data.files;
            this.firstField = data.firstFieldId;
            this.secondField = data.secondFieldId;
            this.fixedPayment = data.fixedPayment;
            this.fromPayment = data.fromPayment;
            this.isOpened = data.opened;
            this.paymentType = data.paymentType;
            this.thirdField = data.thirdFieldId;
            this.toPayment = data.toPayment;

            this.allFields.forEach(element => {
                if (
                    element.depth === 2 &&
                    element.parentId === this.firstField
                ) {
